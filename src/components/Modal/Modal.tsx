      ...
      `}
        ...
        `}
			...
			>
				...
				<main className="px-6 py-5 text-slate-300 font-general text-sm leading-relaxed overflow-y-auto max-h-[60vh]">
					{content ? typeof content === "string" ? <p>{content}</p> : content : children}
				</main>

				<footer className="flex items-center justify-end px-6 py-4 border-t border-slate-800 bg-slate-950/50 gap-3">
					<button
						onClick={onClose}
						type="button"
